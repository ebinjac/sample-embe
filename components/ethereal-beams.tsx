...
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, useState, type FC } from "react"
...
export const Beams: FC<BeamsProps> = ({
  ...
  const themeColors = {
    ...
    beamColor: isDark ? "#000000" : "#ffffff",
    lightIntensity: isDark ? 1 : 0.8,
    ambientIntensity: isDark ? 1 : 0.6
  }
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB(themeColors.beamColor)),
    ...
    [speed, noiseIntensity, scale, themeColors.beamColor],
  )
